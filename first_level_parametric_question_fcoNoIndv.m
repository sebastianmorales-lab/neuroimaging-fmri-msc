...
%vez
    ...
    [matlabbatch] = first_level_parametric_question_job_fcoNoIndv(participant.first_level_folder, participant.trigger_id);
...
save('failedSubjectsByDecisionNoIndv.mat','failsub','failidsub');
