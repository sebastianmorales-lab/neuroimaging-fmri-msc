...
function [matlabbatch] = first_level_parametric_question_job(participant_folder, trigger_id)
...
base_dir = '/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/news/Second_level_parametric_question_times/participantes';
...
[contrastes, all_contrastes] = deal(compute_contrastes_parametric_maestria_question(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM,posicionMB, posicionIndB, posicionIndM));
...
for i_block=1:n_blocks
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(i_block).cond(numero_condicion).duration = bloques{i_block}.social_time ;
...
contrastes_computed = compute_contrastes_parametric_maestria_question(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m,repMB, repIndB,repIndM,posicionMB, posicionIndB,posicionIndM);
