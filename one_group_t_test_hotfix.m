 output_base = "/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/Second_level_parametric_questionnaries/outputs3";
...
for i = desde:hasta
    ...
    for index=1:length(grupos_analisis)
        ...
        for kindex=1:n_contrastes   
            ...
            disp("1*****");
            [matlabbatch] = one_group_t_test_job_hotfix(inputs, output, cuestionario, nombre_cuestionario);
