function [matlabbatch] = first_level_parametric_job(participant_folder, trigger_id)
...
triggers_dir = "/media/usuario/Expansion/maestria_task/trigger";
...
[contrastes, all_contrastes] = deal(compute_contrastes_parametric_2(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM,posicionMB, posicionIndB, posicionIndM));
...
disp(repIndB)
disp(repIndM)
contrastes_computed = compute_contrastes_parametric_2(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m,repMB, repIndB,repIndM,posicionMB, posicionIndB,posicionIndM);
