...
function [matlabbatch] = first_level_parametric_question_job_fcoNoIndv(participant_folder, trigger_id)
...
base_dir = '/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/news/Second_level_parametric_question_timesByDecisionNoIndv/participantes';
...
[contrastes, all_contrastes] = deal(compute_contrastes_parametric_maestria_question_fcoNoIndv(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM,posicionMB, posicionIndB, posicionIndM));
...
for i_block=1:n_blocks
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(i_block).cond(numero_condicion).onset = time_question{i_block};
...
contrastes_computed = compute_contrastes_parametric_maestria_question_fcoNoIndv(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m,repMB, repIndB,repIndM,posicionMB, posicionIndB,posicionIndM);
