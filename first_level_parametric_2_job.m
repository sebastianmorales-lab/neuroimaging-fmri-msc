...
function [matlabbatch] = first_level_parametric_2_job(participant_folder, trigger_id)
...
base_dir = '/media/usuario/Expansion/maestria_task/FMRI/First_level_parametric_2';
...
[contrastes, all_contrastes] = deal(compute_contrastes_parametric_maestria_2(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM,posicionMB, posicionIndB, posicionIndM));
...
contrastes_computed = compute_contrastes_parametric_maestria_2(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m,repMB, repIndB,repIndM,posicionMB, posicionIndB,posicionIndM);
