function [matlabbatch, design_dir] = second_level_parametric_custom_job(contrast, label1, label2);

% contrast={'con_0013'};
% label1={'interaccion_up'};
% label2={'interaccion_dw'};

design_dir = {char(fullfile("//media/usuario/Expansion/maestria_task/FMRI/Second_level_parametric/outputs", contrast))};
inputs_dir = "/media/usuario/Expansion/maestria_task/FMRI/Second_level_parametric/participantes";
