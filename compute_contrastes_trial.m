...
decisionesS1 = whole_task{1,1}.game_type;
decisionesS1_u = string(decisionesS1)=="competitive";
decisionesS1_d = string(decisionesS1)=="individual";

decisionesS2 = whole_task{1,2}.game_type;
decisionesS2_u = string(decisionesS2)=="competitive";
decisionesS2_d = string(decisionesS2)=="individual";

decisionesS3 = whole_task{1,3}.game_type;
decisionesS3_u = string(decisionesS3)=="competitive";
decisionesS3_d = string(decisionesS3)=="individual";

decisionesS4 = whole_task{1,4}.game_type;
decisionesS4_u = string(decisionesS4)=="competitive";
decisionesS4_d = string(decisionesS4)=="individual";
...
total_ind = sum(decisionesS1_d) + sum(decisionesS2_d) + sum(decisionesS3_d) + sum(decisionesS4_d);
