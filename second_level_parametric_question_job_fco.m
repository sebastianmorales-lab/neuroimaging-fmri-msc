function [matlabbatch, design_dir] = second_level_parametric_question_job(contrast, contrastNr, label1, label2);
...
design_dir = {char(fullfile("/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/news/Second_level_parametric_question_timesByDecision/outputs", contrast))};
% 
