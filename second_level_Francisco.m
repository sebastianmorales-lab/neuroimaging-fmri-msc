...
output_base = "/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/Second_level_parametric_questionnaries/outputsCovariates";
%output_base = "D:\Expansion\maestria_task\FMRI\Second_level_parametric_questionnaries\outputsCovariates";
 input_base  = "/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/Second_level_parametric_questionnaries/inputs";
...
desde = find(string(data.Properties.VariableNames) == "Beck_web");
...
for i = desde:hasta
    ...
    for index=1:length(grupos_analisis)
        ...
        for kindex=1:n_contrastes   
            ...
            [matlabbatch] = second_level_Francisco_job(inputs, output, cuestionario, nombre_cuestionario);    
