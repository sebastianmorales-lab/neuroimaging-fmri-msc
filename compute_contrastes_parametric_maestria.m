function [output] = compute_contrastes_parametric_maestria(choice_individual_blocks, outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM, posicionMB, posicionIndB, posicionIndM)
...
contrastes = {
   ...
   {'indB>indM'      [0  0  0  0  0  0  0  1 -1]}                            %  13
   ...
   {'solo_ind_b'     [0  0  0  0  0  0  0  1  0]}                            %  19
   {'solo_ind_m'     [0  0  0  0  0  0  0  0  1]}                            %  20
...
%     end
  ...
  if i_contraste >= 7 && i_contraste <= 13
  ...
  if i_contraste >= 15 && i_contraste <= 20
    if sum(abs(contrast_block))~=4
        contrast_block(:)=0;
    end
  end
