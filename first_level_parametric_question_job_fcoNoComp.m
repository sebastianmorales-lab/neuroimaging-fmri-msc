...
function [matlabbatch] = first_level_parametric_question_job_fcoNoComp(participant_folder, trigger_id)
...
base_dir = '/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/news/Second_level_parametric_question_timesByDecisionNoComp/participantes';
...
[contrastes, all_contrastes] = deal(compute_contrastes_parametric_maestria_question_fcoNoComp(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m, repMB, repIndB, repIndM,posicionMB, posicionIndB, posicionIndM));
...
contrastes_computed = compute_contrastes_parametric_maestria_question_fcoNoComp(choice_individual_blocks,outcomes_individual_b, outcomes_individual_m,repMB, repIndB,repIndM,posicionMB, posicionIndB,posicionIndM);
