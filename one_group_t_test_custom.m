output_base = "/media/sebastian/Seagate Portable Drive/Expansion/maestria_task/FMRI/news/Second_level_parametric_questionnaries/outputsNOsexo&edad";
...
% Filtrar solo las filas donde 'second_level' sea igual a 1
...
for i = desde:hasta
    ...
    for index=1:length(grupos_analisis)
        ...
        for kindex=1:n_contrastes   
            ...
            [matlabbatch] = one_group_t_test_job_custom(inputs, output, cuestionario, nombre_cuestionario);    
